...
def softmax(x, axis=1):
    ...
    return sf
stage='train'
fig_path = '%s_review_3month_group_month_%%s_retrained_polarity.png'% stage
feat_path = '../train_yelp/3m_polarity/%s_score_3month_2.h5' % stage
...
#scores_eval = neg_scores # neg_scores or scores_rating
	...
	print 'mean length of a group is %s' % mean_n_group
